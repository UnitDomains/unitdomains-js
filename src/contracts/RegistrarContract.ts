...
const abi = [
  {
    inputs: [
      ...
      { internalType: 'bytes32[]', name: '_baseNodes', type: 'bytes32[]' },
    ],
  ...
  {
    inputs: [{ internalType: 'bytes32', name: 'baseNode', type: 'bytes32' }],
    name: 'addBaseNode',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint16', name: 'baseNodeIndex', type: 'uint16' },
    ],
    name: 'reclaim',
    outputs: [],
    stateMutability: 'nonpayable',
